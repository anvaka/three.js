...
var NumberKeyframeTrack = require('./tracks/NumberKeyframeTrack.js');
var VectorKeyframeTrack = require('./tracks/VectorKeyframeTrack.js');
var QuaternionKeyframeTrack = require('./tracks/QuaternionKeyframeTrack.js');

function AnimationClip( name, duration, tracks ) {

	this.name = name || THREEMath.generateUUID();
	this.tracks = tracks;
